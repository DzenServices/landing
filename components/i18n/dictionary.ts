  ...
  home: {
      ...
      plans: [
        {
          ...
          buttonAria: "Подключить Dzen VPN",
          benefitList: [
    ...
    faq: {
      ...
      items: [
        ...
        { question: "Какой используется протокол?", answer: "Мы используем современный протокол VLESS + Reality для стабильного и защищённого подключения.", value: "item-7" },
        { question: "Смогу ли я смотреть YouTube и пользоваться AI?", answer: "Да. Вы сможете смотреть YouTube и пользоваться всеми AI‑сервисами. В качестве бонуса — видео на YouTube будет без рекламы.", value: "item-6" },
      ],
    },
  },
  privacy: {
...
const EN: Dictionary = {
  ...
  home: {
    ...
    features: {
      kicker: "Features",
      title: "Comfortable access without hassle",
      ...
      items: [
        ...
        { icon: "Clock", title: "Reliable 24/7", description: "Constant access without interruptions." },
      ...
      plans: [
        {
          ...
          popular: 1,
          price: 3,
          description: "Single price — 3 RUB per day per connected device.",
          buttonText: "Connect",
          buttonAria: "Connect to Dzen VPN",
          benefitList: [
            "Very high speed",
    ...
    faq: {
      ...
      items: [
        ...
        { question: "Which protocol do you use?", answer: "We use the modern VLESS + Reality protocol for stable and secure connections.", value: "item-7" },
        { question: "Will I be able to watch YouTube and use AI?", answer: "Yes. You will be able to watch YouTube and use all AI services. As a bonus, YouTube videos will be without ads.", value: "item-6" },
      ],
    },
  },
  privacy: {
